...
const plans = [
  ...
  },
  {
    ...
    badge: 'Best Value',
    description: 'The most popular choice — pay once a year and forget about it.',
    features: [
  ...
  },
  {
    ...
    subNote: null,
    badge: null,
    description: 'Pay once. Own it forever — no renewals, ever.',
    features: [
    ...
    buttonLabel: 'Get forever access — $299',
    highlight: false,
  },
]
