...
-- The AI Visibility Tracker (tracked_sites, visibility_snapshots) was spun out
-- into its own standalone product — see supabase-migration-remove-aeo-tracker.sql
-- to drop those tables from this project once the standalone product is live.
