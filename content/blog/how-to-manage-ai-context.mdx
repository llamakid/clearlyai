...
<LeadMagnet heading="Want to put this to work?" blurb="Get the free AI Starter Kit — plain-English prompts you can copy and use, so getting good results becomes routine." />
...
If you want to build the full set of habits that make AI actually useful in your day-to-day work — not just prompting basics, but how to think about these tools — that's the core of what we cover in the Clearly, AI courses. [Start learning free.](/signup)
